...
for option in possible_ML_options :
    ...
    sklearn_RF.fit(x_train_bool, y_train_bool)
    y_pred = sklearn_RF.predict(x_test_bool)
    ...
    sklearn_5fold_RF.fit(x_train_bool, y_train_bool)
    print(sklearn_5fold_RF.best_params_)

    sklearn_RF = RandomForestClassifier(n_estimators = sklearn_5fold_RF.best_params_['n_estimators'], 
                                    criterion = sklearn_5fold_RF.best_params_['criterion'],
