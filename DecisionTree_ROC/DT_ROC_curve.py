...
feature_sub = ['sex', 'nursing_diet', 'wt4', 'wt8', 'rbg4', 'rbg8'] #Features to run Decision Tree on, All possible features are below:
...
includeParentOnset = False #Include parent onset as a feature
includeSiblingOnset = True #Include sibling onset as a feature. This includes half-siblings.
...
if (includeParentOnset):
    x['rbg200_fa'] = x['rbg200_fa'] <= week_cutoff
    x['rbg200_mo'] = x['rbg200_mo'] <= week_cutoff
